            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <div class="d-flex justify-content-between align-items-center px-3">
                  <div>
                    <h6 class="text-white text-capitalize ps-3">Student Management</h6>
                    <p class="text-white text-sm ps-3 mb-0">Manage and monitor student profiles</p>
                  </div>
                  <div>
              ...
              <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input type="text" class="form-control" id="searchStudents" aria-label="Search Students">
                  </div>
                </div>
                <div class="col-lg-6 col-md-4 col-sm-12 text-end">
                  <div class="dropdown d-inline">
                    <button class="btn bg-gradient-info dropdown-toggle mb-3" type="button" id="filterDropdown" data-bs-toggle="dropdown" aria-expanded="false">
...
<!-- Add this at the bottom of your file, before closing body tag -->
<div class="modal fade" id="studentModal" tabindex="-1" role="dialog" aria-labelledby="studentModalLabel" aria-hidden="true"></div>
...
<!-- Bootstrap and core dependencies -->
