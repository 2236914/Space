                                ...
                                <div class="card-body mt-2">
                                    <form role="form" class="text-start" id="loginForm">
                                        ...
                                        <div class="text-end mb-auto">
                                            <a href="forgotpassword.php" class="text-primary text-sm font-weight-bold">Forgot Password?</a>
                                        </div>
                                        <div class="text-center">
                                            <button type="submit" class="btn bg-gradient-primary btn-responsive w-100 my-4 mb-2">Sign in</button>
                                        </div>
                                    </form>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('../admin_operations/login.php', {  // Update endpoint path
                method: 'POST',
                body: formData
            });
            ...
            if (result.status === 'success') {
                await Swal.fire({
                    icon: 'success',
                    title: result.title || 'Login Successful',
...
document.addEventListener('DOMContentLoaded', function() {
    // Ensure the password input has the correct ID
