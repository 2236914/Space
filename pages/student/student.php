        ...
        <div class="card">
          <div class="card-header p-2 ps-3">
            <div class="d-flex align-items-center">
              <div class="icon icon-md icon-shape bg-gradient-primary shadow-dark shadow text-center border-radius-lg me-3">
                <i class="material-symbols-outlined opacity-10">group</i>
              </div>
              <div>
                <p class="text-sm mb-0 text-capitalize">Space Check-ins</p>
                <h4 class="mb-0"><?php echo $analytics->getTotalStudents(); ?></h4>
              </div>
            </div>
          </div>
          ...
          <div class="card-footer p-2 ps-3">
            ...
            if (isset($newStudents['error'])) {
              ...
              echo $count > 0 
                ? "<p class='mb-0 text-sm'><span class='text-success font-weight-bolder'>+{$count} </span>new students today</p>"
                : "<p class='mb-0 text-sm'><span class='text-secondary'>No new students today</span></p>";
            }
            ?>
          </div>
        </div>
