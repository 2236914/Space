  ...
  <div class="position-fixed bottom-1 end-1 z-index-2">
    ...
    <div class="toast fade hide p-2 bg-white" role="alert" aria-live="assertive" id="emojiToast" aria-atomic="true">
        ...
        <div class="toast-body">
            Please select at least 1 emoji to express your mood.
        </div>
    </div>
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    ...
    moodForm.addEventListener('submit', async function(e) {
        ...
        try {
            // Validate emojis - check for at least 1
            if (selectedEmojis.filter(e => e).length === 0) {
                throw new Error('Please select at least one emoji to express your mood');
            }
