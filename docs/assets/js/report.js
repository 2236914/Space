    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch('../../admin_operations/report_handlers.php', {
                ...
                body: `action=report_post&post_id=${postId}&reason=${encodeURIComponent(finalReason)}`
            })
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch('../../admin_operations/report_handlers.php', {
                ...
                body: `action=report_user&username=${encodeURIComponent(username)}&reason=${encodeURIComponent(finalReason)}`
            })
            .then(response => response.json())
            .then(data => {
                if (data.success) {
